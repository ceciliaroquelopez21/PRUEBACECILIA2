...
import pe.com.bcp.techcases.testautomation.ui.pages.PracticeFormPage;
...
public class DefaultUser extends ScenarioSteps {
    ...
    @Step
    public void fillsField(String elementName, String value) {
        page.fills(elementName, value);
    }
